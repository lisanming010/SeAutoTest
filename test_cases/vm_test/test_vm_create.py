...
vm_create_conf = {
    'vmconf': {
        ...
        'vm_nic2':{
            ...
            'firewall_name': '',
            'is_use_ipv4': True,
            'ipv4_addr': '192.168.20.105',
            'ipv4_prefix': '255.255.255.0',
            'ipv4_gateway': '192.168.20.254',
            'ipv4_subip_is_use': True,
            'ipv4_subip_set_mode': '指定',
            'ipv4_subip_random_nums': 2,
            'ipv4_subip_appoint_addr': '192.168.20.106-192.168.20.108',
            'is_use_ipv6': False,
            'ipv6_addr': 'fd01:aa1::3',
            'ipv6_prefix': 'ffff:ffff:ffff:ffff::',
            'ipv6_gateway': 'fd02:aa1::1',
